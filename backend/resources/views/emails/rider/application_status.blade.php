    ...
    <div class="body">
        ...
        @if ($event === 'submitted')
            ...
            <div class="status-box">
                ...
                <strong>Référence :</strong> {{ $application->id }}
            </div>
        ...
        @elseif ($event === 'approve')
            ...
            <p>Votre compte livreur est maintenant actif. Connectez-vous sur rider.speedservice.bj pour commencer à accepter des missions.</p>
            <a class="btn" href="{{ config('app.rider_url', 'https://rider.speedservice.bj') }}">Accéder à mon espace</a>
        ...
        @elseif ($event === 'request_complement')
            ...
            @if ($application->complement_request)
                <div class="status-box">
                    <strong>Documents requis :</strong><br>{{ $application->complement_request }}
                </div>
            @endif
            <p>Veuillez soumettre les documents demandés dès que possible via le portail candidat.</p>
            <a class="btn" href="{{ config('app.rider_url', 'https://rider.speedservice.bj') }}/apply/status?id={{ $application->id }}">Soumettre les documents</a>
        @endif
