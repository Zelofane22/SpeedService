...
class DriverApplicationTest extends TestCase
{
    ...
    {
        $this->postJson('/api/driver/apply', $this->validPayload())
            ->assertCreated()
    ...
    public function test_duplicate_email_is_rejected(): void
    {
        ...
        $this->postJson('/api/driver/apply', $payload)->assertCreated();
        $this->postJson('/api/driver/apply', $payload)->assertUnprocessable();
    }

    public function test_apply_requires_mandatory_fields(): void
    {
        $this->postJson('/api/driver/apply', [])
            ->assertUnprocessable()
    ...
    public function test_can_check_application_status(): void
    {
        ...
        $this->getJson('/api/driver/apply/status?application_id=' . $app->id)
            ->assertOk()
    ...
    {
        $this->getJson('/api/driver/apply/status?application_id=' . fake()->uuid())
            ->assertUnprocessable();
    }
    ...
    public function test_complement_rejected_when_status_is_not_complement_requested(): void
    {
        ...
        $this->postJson('/api/driver/apply/complement', [
    ...
    public function test_admin_can_list_applications(): void
    {
        ...
        $this->actingAs($admin, 'sanctum')
            ->getJson('/api/admin/drivers/applications')
            ->assertOk()
    ...
    public function test_admin_can_approve_application(): void
    {
        ...
        $this->actingAs($admin, 'sanctum')
            ->patchJson("/api/admin/drivers/applications/{$app->id}/review", [
                'action' => 'approve',
            ])
            ->assertOk()
